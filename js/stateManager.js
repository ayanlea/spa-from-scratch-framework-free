...
if (window.localStorage == null || window.localStorage == 'undefined') {
    console.log("Check if localStorage is enabled")
...
function hashNavigation() {
    ...
    console.log("hasNavigation() was called")
    var oldhashString = "";
    var arrayVar = [];
...
function changeCountry(country_code) {
    console.log("changeCountry() was called")
    switch (country_code) {
        case 'us':
            return "U.S.A.";
        case 'gb':
...
function getSourceArticleResultsState(dataSourceId) {
    console.log("getSourceArticleResultsState() was called")
    ...
    for (var i in parsedLocalData) {
        if (parsedLocalData[i].source === dataSourceId) {
            articleDataHTML += articlesTemplate.replace(/{{articleSource}}/g, parsedLocalData[i].source)
...
function getSourceByCategoryState(category) {
    console.log("getSourceByCategoryState() was called")
...
function getArticleDetailsState(title) {
    console.log("getArticleDetailsState() was called")
...
function customSideNav() {
    ...
    console.log("customSideNav() was called")
    var userInfo = localStorage.getItem("userObject");
...
function topArticlesState() {
    console.log("topArticlesState() was called")
...
function getSourceListState() {
    console.log("getSourceListState() was called")
    sourcesDataHTML = "";
    for (var key in fullSourceList["sources"]) {
...
function loginState() {
    console.log("loginState() was called")
    showHideElements("login-section");
}

function registerState() {
    console.log("registerState() was called")
    showHideElements("register-section");
}

function getSourceCategoryResults(e) {
    console.log("getSourceCategoryResults() was called")
...
function articleBySourceCalls(dataSourceSort, dataPage, dataSourceId) {
    console.log("articleBySourceCalls() was called")
    var url = "https://newsapi.org/v1/articles?source=";
...
function getCustomCategory(e) {
    console.log("getCustomCategory() was called")
    setActiveClass();
    removeOldElementsByID("news-list");
    removeOldElementsByID("news-details");
    e.setAttribute("class", "active");
...
function getSourceDetails(e) {
    console.log("getSourceDetails() was called")
    removeOldElementsByID("news-list");
    removeOldElementsByID("news-details");
...
function setActiveClass() {
    console.log("setActiveClass() was called")
...
function removeOldElementsByID(elemID) {
    console.log("remoevOldElementsByID() was called")
    articleDataHTML = "";
...
function removeOldElementsWithQueryAll(elemID) {
    console.log("removeOldElementsWithQueryAll() was called")
    articleDataHTML = "";
...
function removeOldElementsByQuery() {
    console.log("removeOldElementsByQuery() was called")
...
function getArticleDetails(e) {
    console.log("getArticleDetails() was called")
    removeOldElementsByID("news-list");
    removeOldElementsByID("news-details");
